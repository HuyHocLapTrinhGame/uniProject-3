...
public class Url {
    ...
    public static final String HISTORY_CONTROLLER = "/priceHistory";
    
    //History care 
    
    public static String HISTORY_LIST_PAGE    = "/historyList.jsp";
    public static String UPDATE_HISTORY_PAGE  = "/updateHistory.jsp";
}
